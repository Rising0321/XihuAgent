      ...
      <div v-else class="host-body">
        ...
        <div class="d-flex jc-center title_wrap">
          ...
          <div class="d-flex jc-center">
            <div class="title">
              <span class="title-text">大语言模型赋能的数智西湖系统</span>
            </div>
          </div>
          <div class="timers">
        ...
        <!-- 头部 e-->
        <!-- 内容  s-->
        <ChartNav @chart-change="handleChartChange" />
...
import ChartNav from "@/components/chart-nav/chart-nav.vue";
import ChartDisplay from "@/components/chart-display/chart-display.vue";
...
export default {
  ...
  methods: {
    ...
    handleChartChange(chartId) {
      this.$refs.chartDisplay.updateChart(chartId);
    }
  },
};
</script>
